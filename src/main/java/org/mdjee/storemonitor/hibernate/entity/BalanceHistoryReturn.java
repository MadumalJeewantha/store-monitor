...
@Entity
@Table(name = "balance_history_return")
public class BalanceHistoryReturn {
    ...
    public BalanceHistoryReturn() {
    }

    public BalanceHistoryReturn(String productId, String batchCode, double availableQuantity,
